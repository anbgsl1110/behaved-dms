...
namespace DbDocGenerate.Utils
{
    ...
    public class Utils
    {
        ...
        public static string CutString(string str, int startIndex, int length, string addstr)
        {
            ...
            {
                var r = str.Substring(startIndex, length);
                result = r + addstr;
            }
            return result;
        }
        ...
        {
            return TypeConverter.StrToBool(expression, false);
        }
        ...
        {
            return StrToDouble(o, 0);
        }
        public static double StrToDouble(object o, double defValue)
        {
            if (o == null) return defValue;
            return StrToDouble(o.ToString(), defValue);
        }
        public static double StrToDouble(string o)
        {
            return StrToDouble(o, 0);
        }
        public static double StrToDouble(string o, double defValue)
        {
            try
            {
        ...
        public static decimal StrToDecimal(object o)
        {
            return StrToDecimal(o, 0);
        }
        public static decimal StrToDecimal(object o, decimal defValue)
        {
            if (o == null) return defValue;
            return StrToDecimal(o.ToString(), defValue);
        }
        public static decimal StrToDecimal(string o)
        {
            return StrToDecimal(o, 0);
        }
        public static decimal StrToDecimal(string o, decimal defValue)
        {
            try
            {
        ...
        {
            return TypeConverter.StrToDateTime(Convert.ToString(objValue));
        }

        public static DateTime StrToDateTime(object objValue, DateTime defValue)
        {
            return TypeConverter.StrToDateTime(Convert.ToString(objValue), defValue);
        }
        ...
        /// <returns></returns>
        public static DateTime UnxiTimestampConvertToDatatime(double timeStamp)
        {
        ...
        public static string CheckImgPath(string addprefix, string imgpath)
        {
        ...
        /// <summary>
        /// 判断 originPic是否为空；
        /// 空则用additionPic，不空则用originPic
        /// </summary>
        /// <param name="addImgPath">添加路径</param>
        /// <param name="originPic">原本图片</param>
        /// <param name="additionPic">备用图片</param>
        /// <returns></returns>
        public static string CheckTeacherPicture(string addImgPath, string originPic, string additionPic)
        {
            if (string.IsNullOrEmpty(originPic))
            {
                return CheckImgPath(addImgPath, additionPic);
            }
            else
            {
                return CheckImgPath(addImgPath, originPic);
            }

        }

        public static string GetSortString(Dictionary<string, string> signDic)
        {
            var sortContent = new StringBuilder();

            var sortDic = new SortedDictionary<string,string>(signDic);
            return GetSortString(sortDic);
        }
        public static string GetSortString(SortedDictionary<string, string> sortDic)
        {
            var sortContent = new StringBuilder();

            #region prepare sort content

            foreach (var item in sortDic)
            {
                sortContent.Append(item.Value);
            }

            #endregion

            return sortContent.ToString();
        }
    }
}
