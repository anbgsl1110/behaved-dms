...
namespace DbDocGenerate.Common
{
    ...
    public class RequestHelper
    {
        ...
        {
            string s = HttpContext.Current.Request.QueryString[strName];
            if (s == null)
                return "";

            if (sqlSafeCheck && !Utils.Utils.IsSafeSqlString(s))
                return "unsafe string";

            return Lib.DoSql(s.Trim());
        }
        ...
        {
            string s = HttpContext.Current.Request.Form[strName];
            if (s == null)
                return "";
        ...
        {
            return Utils.Utils.StrToInt(HttpContext.Current.Request.QueryString[strName], 0);
        }
        ...
        {
            return GetDouble(strName, 0);
        }
        public static double GetDouble(string strName, double defValue)
        {
            return Utils.Utils.StrToDouble(HttpContext.Current.Request[strName], defValue);
        }
        ...
        {
            return Utils.Utils.StrToDecimal(HttpContext.Current.Request[strName], defValue);
        }

        public static DateTime GetDateTime(string strName)
        {
            return GetDateTime(strName, DateTime.Now);
        }

        public static DateTime GetDateTime(string strName, DateTime defValue)
        {
            return Utils.Utils.StrToDateTime(HttpContext.Current.Request[strName], defValue);
        }

        public static string GetIntIds(string strName)
        {
            ...
            foreach (string item in ids.Split(','))
            {
                ...
                _ids += "," + Utils.Utils.StrToInt(item, 0);
            }
            return _ids.Trim(',');
        }
        ...
        /// <returns></returns>
        public static bool IsExistsParam(string paramName)
        {
            return HttpContext.Current.Request.Params.AllKeys.Any(k => k.ToLower() == paramName.ToLower());
        }
        ...
        public static string GetIP()
        {
            ...
            if (string.IsNullOrEmpty(result) || !Utils.Utils.IsIP(result))
                return "127.0.0.1";
