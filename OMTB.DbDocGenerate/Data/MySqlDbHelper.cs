...
namespace DbDocGenerate.Data
{
    ...
    public partial class MySqlDbHelper
    {
        ...
        private static string GetQueryDetail(string commandText, DateTime dtStart, DateTime dtEnd, DbParameter[] cmdParams)
        {
            ...
            if (!Config.BaseConfigs.GetDebug || QueryCount > 100)
            {
                m_querycount = 0;
                m_querydetail = "";
                return "";
        ...
        public static string ConnectionString
        {
            get
            {
                ...
                {
                    m_connectionstring = BaseConfigs.GetRecmdConnString;
                }
            ...
            get
            {
                if (m_provider == null)
                {
                    lock (lockHelper)
                    {
                        if (m_provider == null)
                        {
                            m_provider = (IDbProvider)Activator.CreateInstance(Type.GetType("Study.Data.MySqlProvider, Study.Framework", false, true));
                        }
                    }
                }
                return m_provider;
